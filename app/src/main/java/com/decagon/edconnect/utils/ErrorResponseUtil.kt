...
(var retrofit: Retrofit) {
    fun parseError(response: Response<*>): GenericResponseClass<String> {
        val converter: Converter<ResponseBody, GenericResponseClass<String>> =
            retrofit.responseBodyConverter(GenericResponseClass::class.java, arrayOfNulls<Annotation>(0))
